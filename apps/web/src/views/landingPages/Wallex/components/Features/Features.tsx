          ...
          <Box>
            <Box marginBottom={2}>
              <Typography variant={'h4'} sx={{ fontWeight: 700 }} gutterBottom>
                Esteja sempre no controle da sua vida financeira.
              </Typography>
              <Typography color="text.secondary">
                Acompanhe suas despesas e receitas de forma simples e rápida.
              </Typography>
            </Box>
            <Grid container spacing={1}>
              {[
                'Sincronizar contas a partir do e-mail.',
                'Sincronizar com calendário.',
                'Controle detalhado de gastos na fatura do cartão de crédito.',
                'Relátórios de categorias de despesas.',
                'Gerenciamento de gastos recorrentes.',
                'Alertas.',
              ].map((item, i) => (
