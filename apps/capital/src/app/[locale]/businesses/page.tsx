      ...
      <div className="mx-auto max-w-4xl">
        ...
        <Card className="border-slate-800 bg-slate-900/50 backdrop-blur-sm">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-white">{t('businesses.title')}</CardTitle>
          ...
          <CardContent className="text-center">
            ...
            <div className="mt-6 rounded-lg border border-dashed border-slate-700 bg-slate-800/50 p-6">
              ...
              <ul className="space-y-1 text-sm text-slate-400">
                <li>• {t('businesses.features.createMultiple')}</li>
                <li>• {t('businesses.features.trackIncome')}</li>
                <li>• {t('businesses.features.currencySettings')}</li>
                <li>• {t('businesses.features.transactionHistory')}</li>
                <li>• {t('businesses.features.profitLoss')}</li>
              </ul>
            </div>
          </CardContent>
        </Card>
